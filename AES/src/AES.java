...
//        state[3][c] = (byte) (mul(2, a[3]) ^ a[1] ^ a[2] ^ mul(3, a[0]));
        ...
        state[0][c] = (byte) (mul(2, a[0]) ^ a[2] ^ a[1] ^ mul(3, a[3]));
        state[1][c] = (byte) (mul(2, a[1]) ^ a[3] ^ a[2] ^ mul(3, a[0]));
        state[2][c] = (byte) (mul(2, a[2]) ^ a[0] ^ a[3] ^ mul(3, a[1]));
        state[3][c] = (byte) (mul(2, a[3]) ^ a[1] ^ a[0] ^ mul(3, a[2]));
    }
...
//        state[3][c] = (byte) (mul(0xE, a[3]) ^ mul(0xB, a[0]) ^ mul(0xD, a[1]) ^ mul(0x9, a[2]));
        ...
        state[0][c] = (byte) (mul(0xE, a[0]) ^ mul(0xB, a[3]) ^ mul(0xD, a[2]) ^ mul(0x9, a[1]));
        state[1][c] = (byte) (mul(0xE, a[1]) ^ mul(0xB, a[0]) ^ mul(0xD, a[3]) ^ mul(0x9, a[2]));
        state[2][c] = (byte) (mul(0xE, a[2]) ^ mul(0xB, a[1]) ^ mul(0xD, a[0]) ^ mul(0x9, a[3]));
        state[3][c] = (byte) (mul(0xE, a[3]) ^ mul(0xB, a[2]) ^ mul(0xD, a[1]) ^ mul(0x9, a[0]));
    }
